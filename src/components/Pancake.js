...
class Pancake extends React.Component {
  ...
  getPancakeStatus = () => {
    ...
    // first side
    if (!flippedAt) {
      if (timeCooked < 10) return "raw";
      if (10 < timeCooked < 12) return "cooked";
      return "burnt";
    }

    //second side
    if (10 < flippedAt < 12 || timeCooked > 12) return "burnt";
    if ( 20 < timeCooked < 24 && 10 < flippedAt < 12) return "cooked";
    return "raw";
  };
